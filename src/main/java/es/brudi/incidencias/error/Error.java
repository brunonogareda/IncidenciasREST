...
public enum Error {
	...
	OBTERFACTURA_SERPERMISOS1(231, "Non ten privilexios suficientes para ver esta factura."),
	OBTERFACTURA_SENPERMISOS2(232, "Non ten privilexios suficientes para ver facturas."),
	OBTERFACTURA_ERRORDB(233, "Erro obten a factura da base de datos."),
